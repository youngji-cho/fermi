...
export class MainPage extends React.Component{
  ...
  render(){
    return(
      <Layout>
        <Table name="fermi" content={this.state.exp1}/>
        <Table name="SMP 가격" content={this.state.exp2}>
          <SmpChartA />
          <div className="mdl-card__actions mdl-card--border">
            <a className="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="/smp_price">
            상세보기
            </a>
          </div>
        </Table>
        <Table name="REC 가격" content={this.state.exp3}>
          <RecChartA />
          <div className="mdl-card__actions mdl-card--border">
            <a className="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="/rec_price">
            상세보기
            </a>
          </div>
        </Table>
