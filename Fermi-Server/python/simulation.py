...
def makeCashFlow(cash_flow,tax,construction,principal,equity):
    ...
    cash_flow=cash_flow.loc[:,["date",'operation_cash','smp_revenue','rec_revenue','operation_cash_in','OM_cost','monitoring_cost','elec_safety_cost', 'office_cost', 'other_cost', 'interest','tax', 'operation_cash_out','finance_cash','finance_cash_in','acqusition_asset','finance_cash_out','investment_cash','debt','equity','investment_cash_in','principal','investment_cash_out','cash_change','start_cash','end_cash']]
    return cash_flow
